...
opCode = uint16(17);
Len_1 = uint16(3);
%DATA = uint16([myhex2dec('30') myhex2dec('20') myhex2dec('00') myhex2dec('01') myhex2dec(curr_hex(3:4)) myhex2dec(curr_hex(1:2)) myhex2dec('00') myhex2dec('00') ]);
DATA = uint16([48 32 0 1 myhex2dec(curr_hex(3:4)) myhex2dec(curr_hex(1:2)) 0 0]);
%DATAforCRC = uint16([myhex2dec('1103') myhex2dec('2030') myhex2dec('0100') myhex2dec(curr_hex) myhex2dec('0000') myhex2dec('0000')]);
DATAforCRC = uint16([4355 8240 256 myhex2dec(curr_hex) 0 0]);
numberofWordsCRC = 6;
