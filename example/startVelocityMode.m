function [] = startVelocityMode( obj )
...
opCode = uint16(17);
Len_1 = uint16(3);
%DATA = uint16([myhex2dec('60') myhex2dec('60') myhex2dec('00') myhex2dec('01') myhex2dec('FE') myhex2dec('00') myhex2dec('00')  myhex2dec('00')]);
DATA = uint16([96,96,0,1,254,0,0,0]);
%DATAforCRC = uint16([myhex2dec('1103') myhex2dec('6060') myhex2dec('0100') myhex2dec('00FE') myhex2dec('0000')  myhex2dec('0000')]);
%numberofWordsCRC = 6;
...
opCode = uint16(17);
Len_1 = uint16(3);
%DATA = uint16([myhex2dec('60') myhex2dec('60') myhex2dec('00') myhex2dec('02') myhex2dec('FE') myhex2dec('00') myhex2dec('00')  myhex2dec('00')]);
DATA = uint16([96,96,0,2,254,0,0,0]);
%DATAforCRC = uint16([myhex2dec('1103') myhex2dec('6060') myhex2dec('0200') myhex2dec('00FE') myhex2dec('0000')  myhex2dec('0000')]);
%numberofWordsCRC = 6;
%crc_hex = dec2hex(CRCcalc(DATAforCRC, numberofWordsCRC),4);
%CRC = uint16([myhex2dec(crc_hex(3:4)) myhex2dec(crc_hex(1:2))]);
CRC = uint16([38,155]);
