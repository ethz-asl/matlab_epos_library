...
%Sends the quickStop command to both EPOS
...
%% Quickstop controlword to EPOS NODE 2
...
opCode = uint16(myhex2dec('11'));
Len_1 = uint16(3);
DATA = uint16([myhex2dec('40') myhex2dec('60') myhex2dec('00') myhex2dec('02') myhex2dec('02') myhex2dec('00') myhex2dec('00')  myhex2dec('00')]);
DATAforCRC = uint16([myhex2dec('1103') myhex2dec('6040') myhex2dec('0200') myhex2dec('0002') myhex2dec('0000')  myhex2dec('0000')]);
numberofWordsCRC = 6;
crc_hex = dec2hex(CRCcalc(DATAforCRC, numberofWordsCRC),4);
CRC = uint16([myhex2dec(crc_hex(3:4)) myhex2dec(crc_hex(1:2))]);
