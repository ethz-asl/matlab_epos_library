...
opCode = uint16(hex2dec('11'));
Len_1 = uint16(3);
DATA = uint16([hex2dec('40') hex2dec('60') hex2dec('00') hex2dec('02') hex2dec('06') hex2dec('00') hex2dec('00')  hex2dec('00')]);
DATAforCRC = uint16([hex2dec('1103') hex2dec('6040') hex2dec('0200') hex2dec('0006') hex2dec('0000')  hex2dec('0000')]);
numberofWordsCRC = 6;
crc_hex = dec2hex(CRCcalc(DATAforCRC, numberofWordsCRC),4);
CRC = uint16([hex2dec(crc_hex(3:4)) hex2dec(crc_hex(1:2))]);
